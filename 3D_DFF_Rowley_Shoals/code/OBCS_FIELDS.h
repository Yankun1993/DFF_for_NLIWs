...
C  modified by Lequan Chi
     ...
     &     OBNVam, OBNVph, OBNUam, OBNUph,
     &     BCNRat, BCNAmp, BCNGph
...
C ----------------Add baroclinic tides-----------------
C ----------------Modified by Yankun-----------------

      _RL BCNRat (1-Olx:sNx+Olx,tidalComponents,nSx,nSy)
      _RL BCNAmp (1-Olx:sNx+Olx,tidalComponents*Nr,nSx,nSy)
      _RL BCNGph (1-Olx:sNx+Olx,tidalComponents*Nr,nSx,nSy)
