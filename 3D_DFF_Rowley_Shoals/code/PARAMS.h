...
C-------------------- Fast Station Output by Lequan Chi ----------------------
C     StationMaskFile :: Files containing the mask field of the station output location
C-----------------------------------------------------------------------------
      COMMON /PARM_C/
...
C-------------------- Fast Station Output by Lequan Chi ----------------------
      CHARACTER*(MAX_LEN_FNAM) StationMaskFile
C-----------------------------------------------------------------------------
...
C-------------------- Fast Station Output by Lequan Chi ----------------------
C     StationMask   :: mask field of the station output location
C     StationDumpFreq :: Freqency of Station output
C-----------------------------------------------------------------------------
...
C-------------------- Fast Station Output by Lequan Chi ----------------------
      _RL StationMask(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL StationDumpFreq
C-----------------------------------------------------------------------------
